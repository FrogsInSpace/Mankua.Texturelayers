...
#define TEXLAY_LABEL	_T("T e x t u r e   L a y e r s")
...
// JW Code Change: use macro for "KeyFrameAtTime()" as this got deprecated with Max 2012+
//	KeyFrameAtTime() --> KeyFrameAtTimeByIndex()
#if MAX_VERSION_MAJOR < 14
#define HAS_KEYFRAME_AT_TIME( pb, id, t) (pb->KeyFrameAtTime( pb->IDtoIndex(id), t))
#else
#define HAS_KEYFRAME_AT_TIME( pb, id, t) (pb->KeyFrameAtTimeByIndex( pb->IDtoIndex(id), t))
#endif
...
#define UPDATE_LENGTH_SPIN													\
	...
	length_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME( uvwProy[current_channel]->pblock, uvw_length, t));	
...
#define UPDATE_WIDTH_SPIN													\
	...
	width_spin->SetKeyBrackets(  HAS_KEYFRAME_AT_TIME( uvwProy[current_channel]->pblock , uvw_width, t) );
...
#define UPDATE_HEIGHT_SPIN											\
	...
	height_spin->SetKeyBrackets(  HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock, uvw_height, t) );
...
#define UPDATE_U_TILE_SPIN												\
	...
	u_start_spin->SetKeyBrackets(  HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock, uvw_tile_u, t) );
...
#define UPDATE_U_OFFSET_SPIN											\
	...
	u_offset_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_offset_u, t) );
...
#define UPDATE_V_TILE_SPIN												\
	...
	v_start_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_tile_v, t) );
...
#define UPDATE_V_OFFSET_SPIN											\
	...
	v_offset_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_offset_v, t) );
...
#define UPDATE_W_TILE_SPIN												\
	...
	w_start_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_tile_w, t) );
...
#define UPDATE_W_OFFSET_SPIN											\
	...
	w_offset_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_offset_w, t) );
...
#define UPDATE_ATT_ALL_SPIN												\
	...
	att_all_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_att, t) );
...
#define UPDATE_ATT_U_START_SPIN											\
	...
	att_u_start_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_aus, t) );
...
#define UPDATE_ATT_U_OFFSET_SPIN									\
	...
	att_u_offset_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_aue, t) );
...
#define UPDATE_ATT_V_START_SPIN										\
	...
	att_v_start_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_avs, t) );
...
#define UPDATE_ATT_V_OFFSET_SPIN									\
	...
	att_v_offset_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_ave, t) );
...
#define UPDATE_ATT_W_START_SPIN										\
	...
	att_w_start_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_aws, t) );
...
#define UPDATE_ATT_W_OFFSET_SPIN									\
	...
	att_w_offset_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_awe, t) );
...
#define UPDATE_ATT_RUV_SPIN											\
	...
	att_ruv_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_aruv, t) );
...
#define UPDATE_U_MOVE_SPIN											\
	...
	u_move_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_move_u, t) );
...
#define UPDATE_V_MOVE_SPIN											\
	...
	v_move_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_move_v, t) );
...
#define UPDATE_W_MOVE_SPIN											\
	...
	w_move_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_move_w, t) );
...
#define UPDATE_U_ROTATE_SPIN											\
	...
	u_rotate_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_rotate_u, t) );
...
#define UPDATE_V_ROTATE_SPIN											\
	...
	v_rotate_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_rotate_v, t) );
...
#define UPDATE_W_ROTATE_SPIN											\
	...
	w_rotate_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_rotate_w, t) );
...
#define UPDATE_U_SCALE_SPIN											\
	...
	u_scale_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_scale_u, t) );
...
#define UPDATE_V_SCALE_SPIN											\
	...
	v_scale_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_scale_v, t) );
...
#define UPDATE_W_SCALE_SPIN											\
	...
	w_scale_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_scale_w, t) );
...
//	spin->SetKeyBrackets(  HAS_KEYFRAME_AT_TIME( uvwProy[ channel ]->pblock, uvw_move_u, t) );
...
#define UPDATE_NORMALS_START_SPIN											\
	...
	normals_start_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_normals_start, t) );
...
#define UPDATE_FREE_THRESH_SPIN										\
	...
	free_threshold_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_ffm_thresh, t) );
...
#define UPDATE_PELT_RIGIDITY_SPIN											\
	...
	pelt_rigidity_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_pelt_rigidity, t) );
...
#define UPDATE_PELT_STABILITY_SPIN											\
	...
	pelt_stability_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_pelt_stability, t) );
...
#define UPDATE_PELT_FRAME_SPIN											\
	...
	pelt_frame_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_pelt_frame, t) );
...
#define UPDATE_PELT_ITER_SPIN											\
	...
	pelt_iter_spin->SetKeyBrackets( HAS_KEYFRAME_AT_TIME(uvwProy[current_channel]->pblock,uvw_pelt_iter, t) );
...
//	UPDATE MAIN ROLLUP
	if ( hwnd_main ) {
		if ( uvwProy[current_channel]->GetMappingType()==MAP_TL_SPLINE ) {
			SetWindowText(GetDlgItem(hwnd_main,IDC_TXT_HEIGHT),_T("Radius"));
		//	EnableWindow(GetDlgItem(hwnd_main,IDC_TXT_WIDTH),FALSE);
			}
		else {
			SetWindowText(GetDlgItem(hwnd_main,IDC_TXT_HEIGHT), _T("Height"));
...
void MultiMapMod::GroupsMenuUpdateList() 
{
	...
	for (int i=0; i<uvwProy.Count(); i++) {
		...
		SendDlgItemMessage(	hwnd_main,IDC_TL_GROUPS_MENU,LB_ADDSTRING,0,(LPARAM)(const TCHAR*) name );
...
int MultiMapMod::GetUniqueNameID() {
	...
	for ( int i=0; i<uvwProy.Count(); i++ ) {
		...
		//_tcscspn
		int pos = _tcscspn( group_name.data(), _T("Group "));
		if ( pos==0 ) {
			group_name = group_name.remove(0,6);
			int num = _tstoi( group_name.data() );
			if ( num > max_id )
				max_id = num;
			}
		}
